...
import { SupplierliteRoutingModule } from './supplierlite-routing.module';
...
@NgModule({
  ...
  exports:[EditSupplierLiteComponent],
  imports: [
    CommonModule,
    SupplierliteRoutingModule,
    SharedModule,
    FormsModule,
    NgbDatepickerModule,
    NgSelectModule,
...
export class SupplierliteModule {
