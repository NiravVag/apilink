...
//    [ApiController]
//    public class AuditBookingEaqfController : ExternalBaseController
//    {
...
//        public AuditBookingEaqfController(IInspectionBookingManager manager, ITenantProvider filterService,
...
//        }
//        [HttpPost]
//        public async Task<IActionResult> SaveEaqfInspectionBooking(SaveEaqfAuditRequest request)
//        {
//            var response = await _auditManager.SaveEaqfAuditBooking(request);
//            //status code
...
//                if (piObj != null)
//                {
//                    var bookingEaqfResponse = (AuditEaqfResponse)(piObj.GetValue(response, null));
...
//                    //TO-DO: Un comment the change and resolve the build error
...
//        //TO-DO: Un comment the change and resolve the build error
//        //private async Task SendEmailAndNotifications(SaveEaqfAuditRequest request, AuditEaqfResponse response, IConfiguration configuration)
//        //{
//        //    SetInspNotifyResponse notifRres = null;
//        //    AuditDetails auditRequest = new AuditDetails();
//        //    auditRequest.AuditId = response.MissionId;
//        //    auditRequest.StatusId = response.StatusId;

//        //    notifRres = await _auditManager.BookingTaskNotification(response.MissionId, response.StatusId, auditRequest);
//        //    BookingMailRequest mailData = await _auditManager.GetBookingMailDetail(response.MissionId, true, false, request.UserId);
...
//        //        Subject = $"{entityName} Audit Booking - {subjectStatusName} (AUD - {response.MissionId}, Customer: {mailData.CustomerName}, Supplier: {mailData.SupplierName}"
//        //    };
...
//        //    if (response.StatusId == (int)AuditBookingStatus.Received)
//        //    {
...
//        {
//            var response = await _auditManager.GetEaqfAuditBookingDetails(request);
//            return BuildCommonEaqfResponse(response);
//        }
...
//        {
//            var response = await _auditManager.GetAuditEaqfReportBooking(bookingIds);
//            return BuildCommonEaqfResponse(response);
//        }
