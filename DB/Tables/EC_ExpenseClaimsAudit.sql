CREATE TABLE [dbo].[EC_ExpenseClaimsAudit]
(
    ...
    [DeletedBy] INT NULL,
	FOREIGN KEY ([BookingId]) REFERENCES [AUD_Transaction](Id),
	...
	CONSTRAINT EC_ExpenseClaimsAudit_EntityId FOREIGN KEY(EntityId) REFERENCES AP_Entity(Id)
)
